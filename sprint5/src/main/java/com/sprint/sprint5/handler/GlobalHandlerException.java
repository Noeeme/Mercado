...
import com.sprint.sprint5.exceptions.pedido.*;
...
public class GlobalHandlerException extends ResponseEntityExceptionHandler {
    ...
    private static final String MARCA_INVALIDA = "Marca inválida";
    private static final String TIPO_PAGAMENTO_INVALIDA = "Tipo de pagamento inválido";
    ...
    @ExceptionHandler(value = {MarcaInvalida.class})
    protected ResponseEntity<ErroMensagem> handlerMarcaInvalida(MarcaInvalida e) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErroMensagem(MARCA_INVALIDA));
    }

    @ExceptionHandler(value = {TipoPagamentoInvalido.class})
    protected ResponseEntity<ErroMensagem> handlerTipoPagamentoInvalida(TipoPagamentoInvalido e) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErroMensagem(TIPO_PAGAMENTO_INVALIDA));
    }
